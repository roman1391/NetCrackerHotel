...
<pg:pagination_ajax pparam="${pparam}" paginationResult="${paginationResult}">
    <jsp:attribute name="columnsContent">
                <td class="cell"><span style="white-space:nowrap;"><c:out value="${bo.status}"/></span></td>
                    ...
                    <td class="cell"><span><a href="${contextPath}/admin/check_review/${bo.reviewId}">review</a> </span></td> 
                </jsp:attribute>
</pg:pagination_ajax>
<script>
