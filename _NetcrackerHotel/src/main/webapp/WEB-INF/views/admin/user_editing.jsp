...
<div id="wrapper">
    <div class="container-fluid">
        ...
        <div  style="margin:auto" class="container">
            <p><a href="${contextPath}/admin/list_of_users"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back to user management</a></p>
                    ...
                    <form:form id="updateForm" action="update" method="post" modelAttribute="user"
                        ...
                        <div class="d-inline-block form-group">
                            ...
                            <c:if test="${user.authority eq 'VKONTAKTE_USER' || user.authority eq 'FACEBOOK_USER' || user.authority eq 'TWITTER_USER' }">
                                ...
                                <form:input disabled="true"  path="authority" id="authority" value="${user.authority}"
                                            class="form-control" />
                            </c:if>
