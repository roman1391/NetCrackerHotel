...
INSERT INTO `attribute` (`attribute_id`, `type_id`, `attribute_name`, `datatype`) VALUES (1,1,'first_name','varchar'),(2,1,'last_name','varchar'),(3,1,'username','varchar'),(4,1,'password','varchar'),(5,1,'accesslevel','varchar'),(6,2,'country','varchar'),(7,2,'city','varchar'),(8,2,'address','varchar'),(9,2,'class','int'),(10,3,'cost','int'),(11,3,'capacity','int'),(12,3,'hotel_id','int'),(13,4,'user_id','int'),(14,4,'pay_value','int'),(15,4,'is_paid','int'),(16,5,'room_id','int'),(17,5,'user_id','int'),(18,5,'arrival_date','date'),(19,5,'leave_date','date'),(20,6,'idhotel','int'),(21,6,'photo','varchar'),(22,1,'email','varchar'),(23,1,'enabled','boolean'),(24,1,'authority','varchar'),(25,2,'hotel_name','varchar'),(26,2,'hotel_description','varchar'),(27,7,'token_user_id','int'),(28,7,'token','varchar'),(29,7,'token_date','date'),(30,1,'avatar','varchar'),(31,8,'iduser','int'),(32,8,'hotelid','int'),(33,8,'feedback','varchar'),(34,8,'status','varchar'),(35,8,'time','date'),(36,8,'star','int');
...
INSERT INTO `entity` (`entity_id`, `type_id`) VALUES (7,3),(50,1),(52,2),(53,6),(54,2),(55,2),(56,6),(57,6),(58,2),(59,6),(61,2),(62,6),(63,2),(64,6),(65,2),(66,6),(67,2),(68,6),(69,2),(70,2),(71,2),(72,6),(73,2),(74,6),(75,2),(76,2),(77,6),(78,2),(79,6),(80,1),(81,2),(82,6);
...
INSERT INTO `type` (`type_id`, `name`) VALUES (1,'user'),(2,'hotel'),(3,'room'),(4,'order'),(5,'time_table'),(6,'photos'),(7,'verification_token'),(8,'review');
...
-- Dump completed on 2017-04-19  1:48:59
